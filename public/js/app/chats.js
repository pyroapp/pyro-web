 ...
 function addChat(channel_id, friend_uid) {
    ...
    async function uploadFile() {
        ...
        .then(url => {
            ...
            console.log(url.slice("https://firebasestorage.googleapis.com/v0/b/pyro-chat.appspot.com/o/".length));
            sendPrivateMessage(channel_id, url.slice("https://firebasestorage.googleapis.com/v0/b/pyro-chat.appspot.com/o/".length));
        });
    };
};
