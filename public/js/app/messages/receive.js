...
function loadMessagesInList(channel_id, messages) {
    messages.forEach(async message => {
        ...
        if (reply_message) {
            const { author: { username: reply_username }, content: reply_content } = reply_message;
