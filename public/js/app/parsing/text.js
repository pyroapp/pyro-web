    ...
    while (oldtext.length !== 0) {
        if (oldtext.startsWith("\\")) {
            ...
            if (newtext == "" && oldtext.startsWith("&gt; ") || oldtext.startsWith("\n&gt; ")) {
                console.log(true)
                newtext += `<div class="blockquoteContainer-U5TVEi"><div class="blockquoteDivider-2hH8H6"></div><blockquote>`;
                oldtext = oldtext.slice(oldtext.startsWith("\n&gt; ") ? "\n&gt; ".length : "&gt; ".length);
                markdown.quote = true;

            } else if (oldtext.startsWith("\n") && markdown.quote == true) {
                newtext += "</blockquote></div>"
                oldtext = oldtext.slice(1);
                ...
                if (markdown.spoiler == false) {
                    ...
                    newtext += `<span class="spoilerText-3p6IlD hidden-HHr2R9" aria-expanded="false" tabindex="0" role="button" aria-label="Spoiler"><span class="inlineContent-3ZjPuv">`
                } else {
            ...
            /*
                ...
                newtext += `<img class="emoji" draggable="false" alt=":firebase:" src="https://cdn.discordapp.com/emojis/811084920255807518.gif?v=1" class="${onlyemojis && emojicount <= 27 ? "emoji jumboable" : "emoji"}">`;
